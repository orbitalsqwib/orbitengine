...
#ifndef _ORBIT_MESSAGING_PUBSUB_H
#define _ORBIT_MESSAGING_PUBSUB_H

// import all necessary headers
#include "pubsub/messageBroker.h"

#endif // !_ORBIT_MESSAGING_PUBSUB_H